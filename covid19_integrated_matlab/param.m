...
p(6) = 0.25; % kbase_tran_pc_ipc, rate constant of PC to iPC transition (1/pmole/h) fitted to describe in vivo viral load dynamics
p(7) = 0.25; % kbase_tran_ipc_vpc, rate constant of iPC to vPC transition (1/pmole/h) fitted to describe in vivo viral load dynamics
...
p(15) = 0.5; % k_rep_cov_rna_vpc, rate constant of COV_RNA replication in vPC cell (1/h) fitted to describe in vivo viral load dynamics averaged across 9 patients
...
p(21) = 0; % switch_ir, switch of effect of IR on vPC apoptosis (UL) assumed
p(22) = 50; % T_sw_ir, switch on time of IR effect on vPC apoptosis (h) assumed
p(23) = 190; % ET50_ir, Effective Time when IR effect reach 50% of maximal value (h) assumed
p(24) = 700; % Emax_ir_apo, maximal effect of IR on vPC apoptosis (UL) assumed

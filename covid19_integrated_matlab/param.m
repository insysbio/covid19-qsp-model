...
p(6) = 0.25; % kbase_tran_pc_ipc, rate constant of PC to iPC transition (1/pM/h) fitted to describe in vivo viral load dynamics
p(7) = 0.25; % kbase_tran_ipc_vpc, rate constant of iPC to vPC transition (1/pM/h) fitted to describe in vivo viral load dynamics

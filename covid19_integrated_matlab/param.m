...
p(6) = 10; % kbase_tran_pc_ipc, rate constant of PC to iPC transition (1/pM/h) fitted to describe in vivo viral load dynamics
p(7) = 10; % kbase_tran_ipc_vpc, rate constant of iPC to vPC transition (1/pM/h) fitted to describe in vivo viral load dynamics

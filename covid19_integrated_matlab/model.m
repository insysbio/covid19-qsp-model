%%%% This code was generated by heta-compiler of v0.5.4
% 
...
function [ode_func, out_func, y0_, events_] = nameless_Model(p)
    ...
    function y__ = InitFunc()
        ...
        COV_num_sputum_ml = p(3) * (COV + COV_RNA) * Vol_alv * p(2) / 1000; % COV_num_sputum_ml, number of virus copies in 1 mL of sputum (item/mL)
        ...
        IR_apo = 1 + p(21) * p(24) * (time - p(22)) ^ p(25) / ((p(22) + p(23)) ^ p(25) + (time - p(22)) ^ p(25)); % IR_apo, empiric function imitating effect of Immune Response on vPC apoptosis (UL)
    ...
    function dydt = ODEFunc(time, y)
        ...
        IR_apo = 1 + p(21) * p(24) * (time - p(22)) ^ p(25) / ((p(22) + p(23)) ^ p(25) + (time - p(22)) ^ p(25));
        ...
        % concentration of anti-Spike attibodies (pmole) hill like expression describes general kinetic pattern observed for Spike specific IgG and IgM in [32350462]
        anti_Ab = p(21) * p(27) * (time - p(22)) ^ p(25) / ((p(22) + p(23)) ^ p(25) + (time - p(22)) ^ p(25));

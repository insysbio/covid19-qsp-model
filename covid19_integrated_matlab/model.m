%%%% This code was generated by heta-compiler of v0.5.7
% 
...
function [ode_func, out_func, y0_, events_] = nameless_Model(p)
    ...
    function [res, isterminal, direction] = viral_load_condition(time, y)
        direction = 1; % [];
        isterminal = 1;
    ...
    viral_load_ = { @viral_load_condition, @viral_load_affect };

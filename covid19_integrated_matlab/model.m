%%%% This code was generated by heta-compiler of v0.5.13
% 

function [ode_func, out_func, y0_, events_conditions, events_affects, reinit_y0] = nameless_Model(p)
    ...
    function y__ = InitFunc()
        ...
        y__ = [switch_ir; Vol_alv; PC * Vol_alv; iPC * Vol_alv; vPC * Vol_alv; PC_hs_ss * Vol_alv; ACE2_pc; ACE2_pc_hs_ss; COV_ACE2_pc; ACE2_ipc; COV_ACE2_ipc; COV_ipc; ACE2_vpc; COV_ACE2_vpc; COV_vpc; COV_RNA_vpc; COV * Vol_alv; COV_RNA * Vol_alv; COVass_vpc];
    end

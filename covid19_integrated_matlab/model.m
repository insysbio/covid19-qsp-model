%%%% This code was generated by heta-compiler of v0.5.5
% 
...
function [ode_func, out_func, y0_, events_] = nameless_Model(p)
    ...
    function y__ = InitFunc()
        ...
        COV = 4e-4; % COV, concentration of  COV (SARS-CoV-2 virus) (pM)
        COV_RNA = 0; % COV_RNA, concentration of COV_RNA released from vPC due to their apoptosis (pM)
        COV_num_sputum_ml = p(3) * (COV + COV_RNA) * p(2) / p(29); % COV_num_sputum_ml, number of virus copies in 1 mL of sputum (item/mL)
        ...
        IR_apo = 1 + p(21) * p(24) * (time / p(22) - 1) ^ p(25) / ((1 + p(23) / p(22)) ^ p(25) + (time / p(22) - 1) ^ p(25)); % IR_apo, empiric function imitating effect of Immune Response on vPC apoptosis (UL)
        ...
        k_syn_ace2_pc = p(8) * ACE2_pc_hs_ss / PC_hs_ss / p(28) / Vol_alv / p(1); % k_syn_ace2_pc, rate of ACE2 synthesis calculated per volume of PC (pM/h)
        ...
        anti_Ab = p(21) * p(27) * (time / p(22) - 1) ^ p(25) / ((1 + p(23) / p(22)) ^ p(25) + (time / p(22) - 1) ^ p(25)); % anti_Ab, concentration of anti-Spike attibodies (pM)
        VO = anti_Ab / (p(26) + anti_Ab); % VO, Virus Occupancy (VO) level with anti_Ab antibodies (UL)
    ...
    function dydt = ODEFunc(time, y)
        ...
        COV_num_sputum_ml = p(3) * (COV + COV_RNA) * p(2) / p(29);
        ...
        IR_apo = 1 + p(21) * p(24) * (time / p(22) - 1) ^ p(25) / ((1 + p(23) / p(22)) ^ p(25) + (time / p(22) - 1) ^ p(25));
        ...
        anti_Ab = p(21) * p(27) * (time / p(22) - 1) ^ p(25) / ((1 + p(23) / p(22)) ^ p(25) + (time / p(22) - 1) ^ p(25));
        % Virus Occupancy (VO) level with anti_Ab antibodies (UL) 
        VO = anti_Ab / (p(26) + anti_Ab);

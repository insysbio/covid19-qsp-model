...
nameless.parameter.k_rep_cov_rna_vpc = addparameter(nameless_model, 'k_rep_cov_rna_vpc', 'ConstantValue', true, 'Value', 0.5, 'ValueUnits', '1/hour', 'Notes', '<p>fitted to describe in vivo viral load dynamics averaged across 9 patients</p>', 'Tag', '');
...
nameless.parameter.switch_ir = addparameter(nameless_model, 'switch_ir', 'ConstantValue', true, 'Value', 0, 'ValueUnits', 'dimensionless', 'Notes', '<p>assumed</p>', 'Tag', '');

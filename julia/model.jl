...
function nameless_init_func_(cons)
    ...
    switch_ir = 0.0
    IR_apo = 1.0 + switch_ir * cons[23] * (t / cons[21] - 1.0) ^ cons[24] / ((1.0 + cons[22] / cons[21]) ^ cons[24] + (t / cons[21] - 1.0) ^ cons[24])
    ...
    anti_Ab = switch_ir * cons[26] * (t / cons[21] - 1.0) ^ cons[24] / ((1.0 + cons[22] / cons[21]) ^ cons[24] + (t / cons[21] - 1.0) ^ cons[24])
